...
//		}
	...
	List<ActivityOrder> ao = activityOrderService.selectActivetyOrderByParticularUser(userGet);
...
public String showHistory(Model model, Principal principal) {
	String userGet = principal.getName();
	List<HistorySell> hs = historySellService.findParticularUserHistoryBuy(userGet);
